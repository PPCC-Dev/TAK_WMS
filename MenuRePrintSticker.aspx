<%@ Page Title="WMS Reprint Sticker Barcode Conditions" Language="VB" MasterPageFile="~/SiteMasterNew.master" AutoEventWireup="false" CodeFile="MenuRePrintSticker.aspx.vb" Inherits="MenuRePrintSticker" %>
    ...
    <div class="container pt-5">
       ...
       <div class="row pt-4">
            <div id="divBCGRN" class="col-4 text-center chover rounded" runat="server">
                <asp:HyperLink ID="LinkBCGRN" runat="server" NavigateUrl="~/RePrintStickerBarcode.aspx?Print=GRN">
            ...
            <div id="divBCMiscReceipt" class="col-4 text-center chover rounded" runat="server">
                <asp:HyperLink ID="LinkBCMiscReceipt" runat="server" NavigateUrl="~/RePrintStickerBarcode.aspx?Print=Misc. Receipt">
            ...
            <div id="divBCQtyMove" class="col-4 text-center chover rounded" runat="server">
                <asp:HyperLink ID="LinkBCQtyMove" runat="server" NavigateUrl="~/RePrintStickerBarcode.aspx?Print=Qty Move">
       ...
       <div class="row pt-4">
            <div id="divBCRMA" class="col-4 text-center chover rounded" runat="server">
                <asp:HyperLink ID="LinkBCRMA" runat="server" NavigateUrl="~/RePrintStickerBarcode.aspx?Print=RMA">
            ...
            <div id="divBCUnpostedJob" class="col-4 text-center chover rounded" runat="server">
                <asp:HyperLink ID="LinkBCUnpostedJob" runat="server" NavigateUrl="~/RePrintStickerBarcode.aspx?Print=Unposted Job">
