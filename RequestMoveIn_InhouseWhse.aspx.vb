...
Partial Class Default2
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Session("CanAccessReqMoveInhouse") <> "1" Then Response.Redirect("default.aspx")
            ...
            If txtBarcode.Text <> String.Empty Then
                ...
                If iCheck > 0 Then
                    ...
                    If iSubmit = 0 Then
                        ...
                        res = New Object
                        res = oWS.CallMethod(Session("Token").ToString, "PPCC_WMSHistoryReqMoves", "PPCC_WMSProcessReqMove_InhouseSp", Parms)
                        ...
                        If iCount = 0 Then
                            ...
                            If CountNoTask = 0 Then
                                ...
                                oWS.CallMethod(Session("Token").ToString, "PPCC_WMSTmpReqMoveOuts", "PPCC_WMSAutoMoveTmp_InhouseSp", Parms)
    ...
    Sub LoadUserInfo()
        ...
        ds = New DataSet
        oWS = New SLWebServices.DOWebServiceSoapClient
        ds = oWS.LoadDataSet(Session("Token").ToString, "SLInvparms", "invUf_Invparms_InhouseWhse_to", "", "", "", 0)
        If ds.Tables(0).Rows.Count > 0 Then

            Session("UserWhse") = ds.Tables(0).Rows(0)("invUf_Invparms_InhouseWhse_to").ToString
